      ...
      <div class="card-body table-responsive p-0">
              <table id="table_id" class="display table table-hover text-nowrap">
                <thead>
                  ...
                  $nomineeTypeName = "SELECT companyName FROM wapendekezwa WHERE id IN(SELECT pendekezwaID FROM wapendekezanawapendekezwa)";
                  ...
                  <?php 
                    ...
                    if ($normineeName->num_rows > 0) {
                      while($row = $normineeName->fetch_assoc()) {
                        ...
                        echo "<tr><td>" . $NO. "</td><td>". $Nnamee."</td>";
                        $NO++;
                      }
                    } else {
                      echo "<tr><td>No Nominated company yet</td></tr>";
                    }
                  ?>
                  </tr>
                </tbody>
