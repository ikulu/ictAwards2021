...
$forLink = 0;
    ...
    $q = $_GET['q'];
    $sql="SELECT DISTINCT(wapendekezanawapendekezwa.pendekezwaID),wapendekezwa.companyName,wapendekezanawapendekezwa.id FROM wapendekezanawapendekezwa,wapendekezwa WHERE wapendekezwa.id = wapendekezanawapendekezwa.pendekezwaID AND wapendekezanawapendekezwa.categoriesFK = '$q'";
    // $sql="SELECT distinct(wapendekezwa.companyName),wapendekezanawapendekezwa.pendekezwaID,wapendekezanawapendekezwa.id FROM wapendekezanawapendekezwa,wapendekezwa WHERE wapendekezwa.id = wapendekezanawapendekezwa.pendekezwaID AND wapendekezanawapendekezwa.categoriesFK = '".$q."'";
